...
var errorList =$set(exports, "errorList", require("hsp/rt").template(["errors"], function(n){
  var _errors,_error,_msg;try {_errors=errors} catch(e) {_errors=n.g('errors')};try {_error=error} catch(e) {_error=n.g('error')};try {_msg=msg} catch(e) {_msg=n.g('msg')};
  var __s = {errors : typeof errors === 'undefined' ? n.g('errors') : errors, error : typeof error === 'undefined' ? n.g('error') : error, msg : typeof msg === 'undefined' ? n.g('msg') : msg};
  return [__s,n.$if({e1:[9,"errors && errors.length"]},1,[n.elt("div",0,{"class":"errorlist"},0,[n.elt("ul",0,0,0,[n.$foreach({e1:[9,"errors"]},"error_key","error",0,1,[n.elt("li",0,0,0,[n.$if({e1:[9,"error.messages"]},1,[n.elt("div",{e1:[9,"error.type"]},{"class":["",1]},0,[n.$foreach({e1:[9,"error.messages"]},"msg_key","msg",0,1,[n.$text({e1:[9,"msg"]},["",1]),n.elt("br",0,0,0)]),n.$text(0,[" "])])],[n.$if({e1:[9,"error.message"]},1,[n.elt("div",{e1:[9,"error.type"]},{"class":["",1]},0,[n.$text({e1:[9,"error.message"]},[" ",1," "])])])]),n.$if({e1:[9,"error.line || error.file"]},1,[n.elt("div",0,{"class":"ctxt"},0,[n.$text({e1:[9,"error.file"]},["[",1,"] "]),n.$if({e1:[9,"error.line"]},1,[n.$text({e1:[9,"error.line"],e2:[9,"error.column"]},["line: ",1,", column: ",2])])])]),n.$if({e1:[9,"error.code"]},1,[n.elt("div",0,{"class":"code"},0,[n.$text(0,[">> code: "]),n.elt("span",0,{"class":"codetext"},0,[n.$text({e1:[9,"error.code"]},["",1])])])])])]),n.$text(0,[" "])])])])];
}));