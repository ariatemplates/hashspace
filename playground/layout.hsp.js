...
var sampleList = require("hsp/rt").template(["data","playground"], function(n){
  var _data,_hideNavHover,_event,_collapseNav,_playground,_showListHover,_sample,_index;try {_data=data} catch(e) {_data=n.g('data')};try {_hideNavHover=hideNavHover} catch(e) {_hideNavHover=n.g('hideNavHover')};try {_event=event} catch(e) {_event=n.g('event')};try {_collapseNav=collapseNav} catch(e) {_collapseNav=n.g('collapseNav')};try {_playground=playground} catch(e) {_playground=n.g('playground')};try {_showListHover=showListHover} catch(e) {_showListHover=n.g('showListHover')};try {_sample=sample} catch(e) {_sample=n.g('sample')};try {_index=index} catch(e) {_index=n.g('index')};
