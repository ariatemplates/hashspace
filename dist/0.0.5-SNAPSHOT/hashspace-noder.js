 ...
 */
     ...
     */
            $constructor: function(desc, eh) {
                var etype = desc[0], pl = desc[1], isLiteral = etype === 2 || etype === 4, root, path = [], ppl;
                // pl: path
                // length
                if (!isLiteral) {
                ...
                this.bound = etype === 1;
                // literal data ref are considered unbound
     ...
     */
            getObservablePairs: function(eh, vscope) {
                ...
                if (this.bound && r && r.length >= 1) {
                    var sz = r.length, lastRefOwner = r[sz - 1][0], lastRef = lastRefOwner[r[sz - 1][1]];
 ...
 */
     ...
     */
            $constructor: function(desc, eh) {
                ...
                this.opairs = null;
                // observable pairs (if null == non initialized)
            ...
            startGesture: function(evtName, target, evtHandler) {
                ...
                if (typeof mapping != "undefined") {
                    ...
                    if (!alreadyInstanciated) {
                        this.evtHandlers.push({
                            name: mapping.name,
                            instance: new mapping.klass(target, evtHandler)
                        });
                    }
                }
            },
     ...
     */
            ...
            $dispose: function() {
                ...
                if (evh) {
                    ...
                    var rmEL = nd.removeEventListener !== undefined;
 ...
 */
        // Hash Space runtime
        require("./es5");
        var klass = require("./klass"), log = require("./rt/log"), $root = require("./rt/$root"), $RootNode = $root.$RootNode, $CptNode = $root.$CptNode, $CptAttElement = $root.$CptAttElement, cptwrapper = require("./rt/cptwrapper");
