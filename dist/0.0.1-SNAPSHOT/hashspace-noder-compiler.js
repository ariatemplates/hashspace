(function(define) {
    define("hsp/compiler/hspblocks.peg.js", [], function(module, global) {
   ...
   */
    ...
    define("hsp/compiler/htmlEntities.js", [], function(module, global) {
        var require = module.require, exports = module.exports, __filename = module.filename, __dirname = module.dirname;
 ...
 */
    ...
    define("hsp/compiler/parser.js", [ "../klass", "./hspblocks.peg.js", "./htmlEntities.js" ], function(module, global) {
        var require = module.require, exports = module.exports, __filename = module.filename, __dirname = module.dirname;
 ...
 */
            ...
            _process: function(node) {
                ...
                switch (node.type) {
                  ...
                  case "UnaryExpression":
                    // e.g. !x +x -x typeof x ++x and --x will not be supported
    ...
    define("hsp/compiler/treeWalker.js", [ "../klass" ], function(module, global) {
        var require = module.require, exports = module.exports, __filename = module.filename, __dirname = module.dirname;
        var klass = require("../klass");
    ...
    define("hsp/compiler/processors.js", [], function(module, global) {
        var require = module.require, exports = module.exports, __filename = module.filename, __dirname = module.dirname;
 ...
 */
        exports["template"] = function(node, walker) {
            ...
            if (node.controller) {
                ...
                return [ "var ", tplName, exp, ' = require("hsp/rt").template({ctl:[', p[0], ",", walker.each(p, argAsString), '],ref:"', node.controller.ref, '"}, function(n){', CRLF, gss, "  return ", tplCode, ";", CRLF, "});", CRLF ].join("");
            } else {
                return [ "var ", tplName, exp, ' = require("hsp/rt").template([', walker.each(node.args, argAsString), "], function(n){", CRLF, gss, "  return ", tplCode, ";", CRLF, "});", CRLF ].join("");
            }
        };
        /**
 ...
 */
        function formatTextBlock(node, nextExprIdx, walker) {
            var c = node.content, sz = c.length, itm, expArr = [], args = [], idx = 0;
    ...
    define("hsp/compiler/jsvalidator/validator.js", [ "acorn/acorn" ], function(module, global) {
        var require = module.require, exports = module.exports, __filename = module.filename, __dirname = module.dirname;
 ...
 */
        function formatError(err, input) {
            var msg = err.toString().replace(/\s*\(\d*\:\d*\)\s*$/i, "");
            ...
            var lineInfoHTML = [ '<span class="code">', before, '<span class="error" title="', msg, '">', errChar, "</span>", after.slice(1), "</span>" ].join("");
            return {
                description: msg,
    ...
    define("hsp/compiler/compiler.js", [ "./parser", "../klass", "./treeWalker", "./processors", "./jsvalidator/validator" ], function(module, global) {
        var require = module.require, exports = module.exports, __filename = module.filename, __dirname = module.dirname;
