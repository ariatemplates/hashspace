...
describe("Input Elements", function () {
	...
	it("validates text elements", function() {
		var v1="edit me!";
		var d={comment:v1, isChecked:false, selection:"B"}
		var n=inputSample(d);
	...
	it("validates checkbox elements", function() {
		var d={comment:"foo", isChecked:true, selection:"B"}
		var n=inputSample(d);
