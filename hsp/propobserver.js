...
var PropObserver = klass({
	...
	/**
	 * Safely delete all internal dependencies
	 * Must be called before deleting the object
	 */
	$dispose:function() {
...
/**
 * Notify the change to the registered observers
 * i.e. call their onPropChange method with the change description as parameter
 * @private
 */
