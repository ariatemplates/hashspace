 ...
 */
 ...
 /**
 * Utility methods to fire DOM events.
 ...
 */
exports.fireEvent = function (eventType, target, options) {
 ...
 * @method
 */
exports.fireKeydownEventAdaptedForKeyNav = function (target, options) {
 ...
 * @static
 */
function simulate(target, type, options) {

    options = options || {};

    if (events[type]) {
        simulateEvent(target, type, options);
    } else if (keyEvents[type]) {
        simulateKeyEvent(target, type, options);
 ...
 * @param {String} type The type of event to fire. This can be any one of the following: keyup, keydown, and keypress.
 * @param {Object} options (Optional) Extra options to copy onto the event object.
 * 
 */
function simulateKeyEvent (target, type, options) {
 ...
 * differences in the DOM and IE event models as well as different browser quirks.
 * @method simulateEvent @private
 * @static 
 * @param {HTMLElement} target The target of the given event.
 * @param {String} type The type of event to fire. This can be any one of the following: click, dblclick, mousedown, mouseup, mouseout, mouseover, and
 * mousemove, touchstart, touchend, touchmove.
 * @param {Object} options (Optional) Extra options to copy onto the event object.
 */
function simulateEvent (target, type , options) {
    var document = window.document;
    ...
    var changedTouches = options.changedTouches;
 ...
 */
function generateTouchList (list) {
