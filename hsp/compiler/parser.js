...
var SyntaxTree=klass({
	...
	_if:function(idx,blocks,out) {
		...
		var condition=new HExpression(b.condition);
...
var HExpression = klass({
	/**
	 * Process the HExpression node parsed by the PEG grammar to generate a more digestable
	 * format for the syntax tree (note:processing is mostly for the JSExpression parts)
