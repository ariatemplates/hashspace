 ...
 * @param tplFilePath {String} the name of the file being compiled (optional - used for error messages)
 ...
 */
exports.compile = function (template, tplFilePath, includeSyntaxTree, bypassJSvalidation) {
    // Parsing might throw an exception
    var res = {};
    var path = tplFilePath || '';
