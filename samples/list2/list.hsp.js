...
var test = require("hsp/rt").template(["d"], function(n){
  ...
  return [__s,n.$text(0,["Click on an item to select it:  "]),n.cpt([_list,"list"],{e1:[4,1,_showSelection,1,2],e2:[0,2,"event","value"]},{"head":"Static list","class":"listcpt"},{"select":1},[n.catt("option",{e1:[1,2,"d","itemName"]},{"value":"A","label":["First ",1]},0),n.catt("option",0,{"value":"B"},0,[n.$text({e1:[9,"d.itemName"]},["Second ",1])])]),n.$text(0,[" "]),n.cpt([_list,"list"],{e1:[4,1,_showSelection,1,2],e2:[0,2,"event","value"]},{"class":"listcpt"},{"select":1},[n.catt("head",0,0,0,[n.$text(0,["Dynamic list: "]),n.elt("a",{e1:[4,1,_empty]},0,{"click":1},[n.$text(0,["Empty"])]),n.$text(0,[" - "]),n.elt("a",{e1:[4,1,_update]},0,{"click":1},[n.$text(0,["Update list"])])]),n.$foreach({e1:[9,"d.items"]},"idx","itm",0,1,[n.catt("option",{e1:[1,1,"idx"]},{"value":["K",1]},0,[n.$text({e1:[9,"idx+1"],e2:[9,"itm"]},["",1,". ",2])])]),n.$text(0,[" "])]),n.$text(0,[" "]),n.$if({e1:[9,"d.selectedItem!==null"]},1,[n.$text({e1:[9,"d.selectedItem"]},["Last selected value: ",1])])];
});
