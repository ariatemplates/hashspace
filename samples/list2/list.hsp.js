...
var test = require("hsp/rt").template(["d"], function(n){
  var _showSelection,_d,_list,_empty,_update,_idx,_itm;try {_showSelection=showSelection} catch(e) {_showSelection=n.g('showSelection')};try {_d=d} catch(e) {_d=n.g('d')};try {_list=list} catch(e) {_list=n.g('list')};try {_empty=empty} catch(e) {_empty=n.g('empty')};try {_update=update} catch(e) {_update=n.g('update')};try {_idx=idx} catch(e) {_idx=n.g('idx')};try {_itm=itm} catch(e) {_itm=n.g('itm')};
  var __s = {showSelection : typeof showSelection === 'undefined' ? n.g('showSelection') : showSelection, d : typeof d === 'undefined' ? n.g('d') : d, list : typeof list === 'undefined' ? n.g('list') : list, empty : typeof empty === 'undefined' ? n.g('empty') : empty, update : typeof update === 'undefined' ? n.g('update') : update, idx : typeof idx === 'undefined' ? n.g('idx') : idx, itm : typeof itm === 'undefined' ? n.g('itm') : itm};
  return [__s,n.$text(0,["Click on an item to select it:  "]),n.cpt([_list,"list"],{e1:[4,1,_showSelection,1,2],e2:[0,2,"event","value"]},{"head":"Static list","class":"listcpt"},{"select":1},[n.catt("option",{e1:[1,2,"d","itemName"]},{"value":"A","label":["First ",1]},0),n.catt("option",0,{"value":"B"},0,[n.$text({e1:[9,"d.itemName"]},["Second ",1])])]),n.$text(0,[" "]),n.cpt([_list,"list"],{e1:[4,1,_showSelection,1,2],e2:[0,2,"event","value"]},{"class":"listcpt"},{"select":1},[n.catt("head",0,0,0,[n.$text(0,["Dynamic list: "]),n.elt("a",{e1:[4,1,_empty]},{"href":"javascript:void(0)"},{"click":1},[n.$text(0,["Empty"])]),n.$text(0,[" - "]),n.elt("a",{e1:[4,1,_update]},{"href":"javascript:void(0)"},{"click":1},[n.$text(0,["Update list"])])]),n.$foreach({e1:[9,"d.items"]},"idx","itm",0,1,[n.catt("option",{e1:[1,1,"idx"]},{"value":["K",1]},0,[n.$text({e1:[9,"idx+1"],e2:[9,"itm"]},["",1,". ",2])])]),n.$text(0,[" "])]),n.$text(0,[" "]),n.$if({e1:[9,"d.selectedItem!==null"]},1,[n.$text({e1:[9,"d.selectedItem"]},["Last selected value: ",1])])];
});
