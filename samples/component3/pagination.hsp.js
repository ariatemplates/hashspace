...
var pagination = require("hsp/rt").template({ctl:[Pagination,"Pagination"],ref:"p"}, function(n){
  ...
  var __s = {p : typeof p === 'undefined' ? n.g('p') : p};
...
var paginationTest = require("hsp/rt").template(["model"], function(n){
  ...
  var __s = {updateSelection : typeof updateSelection === 'undefined' ? n.g('updateSelection') : updateSelection, pagination : typeof pagination === 'undefined' ? n.g('pagination') : pagination};
