...
var people = require("hsp/rt").template(["d"], function(n){
  ...
  return [__s,n.elt("div",0,{"class":"msg"},0,[n.$text(0,["Click on a person to see more details:"])]),n.elt("ul",0,{"class":"noTextSelection"},0,[n.$foreach({e1:[9,"d.people"]},"p_key","p",0,1,[n.elt("li",{e1:[6,function(a0,a1) {return [((a0)? ''+"details":''),(((a1 === "Bart"))? ''+"special":'')].join(' ');},2,3],e2:[1,2,"p","showdetails"],e3:[1,2,"p","name"],e4:[4,1,_toggleDetails,1,5],e5:[1,1,"p"]},{"class":["",1]},{"click":4},[n.$text({e1:[9,"p.name"]},["",1," "]),n.$if({e1:[9,"p.showdetails"]},1,[n.$text({e1:[9,"p.age"]},[": ",1," years old"])])])]),n.$text(0,[" "])]),n.elt("div",0,{"class":"msg"},0,[n.$text({e1:[9,"d.people.length"]},["Number of people in the list: ",1," "])])];
});
