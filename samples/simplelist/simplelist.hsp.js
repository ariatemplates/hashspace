...
var people = require("hsp/rt").template(["d"], function(n){
  var _toggleDetails,_p;try {_toggleDetails=toggleDetails} catch(e) {_toggleDetails=n.g('toggleDetails')};try {_p=p} catch(e) {_p=n.g('p')};
  var __s = {toggleDetails : typeof toggleDetails === 'undefined' ? undefined : toggleDetails, p : typeof p === 'undefined' ? undefined : p};
