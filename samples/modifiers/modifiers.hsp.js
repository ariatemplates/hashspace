...
var sample = require("hsp/rt").template(["d"], function(n){
  ...
  var __s = {changeCase : typeof changeCase === 'undefined' ? n.g('changeCase') : changeCase, Sorter : typeof Sorter === 'undefined' ? n.g('Sorter') : Sorter, d : typeof d === 'undefined' ? n.g('d') : d, sortByName : typeof sortByName === 'undefined' ? n.g('sortByName') : sortByName};
  return [__s,n.elt("div",0,{"class":"section2"},0,[n.$text(0,["Message in capital letters: "]),n.elt("span",0,{"class":"textvalue"},0,[n.$text({e1:[4,1,_changeCase,1,2,0,"upper"],e2:[1,2,"d","msg"]},["",1])]),n.elt("br",0,0,0),n.$text(0,["Message in lower case: "]),n.elt("span",0,{"class":"textvalue"},0,[n.$text({e1:[4,1,_changeCase,1,2,0,"lower"],e2:[1,2,"d","msg"]},["",1])])]),n.elt("div",0,{"class":"section2"},0,[n.let({e1:[9,"sortByName=new Sorter(\"firstName\")"]}),n.$text(0,["Sorted list: "]),n.elt("ol",0,0,0,[n.$foreach({e1:[9,"d.persons|sortByName"]},"p_key","p",0,1,[n.elt("li",0,0,0,[n.$text({e1:[1,2,"p","firstName"],e2:[1,2,"p","lastName"]},["",1," ",2," "])])]),n.$text(0,[" "])]),n.elt("a",{e1:[3,2,"sortByName","toggleOrder"]},0,{"click":1},[n.$text({e1:[6,function(a0) {return (a0? "ascending" : "descending");},2],e2:[1,2,"sortByName","ascending"]},["Toggle sort order (current: ",1,") "])])],1)];
});
