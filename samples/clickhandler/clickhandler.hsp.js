...
var message = require("hsp/rt").template(["msg"], function(n){
  ...
  return [__s,n.elt("div",{e1:[9,"changeMessage()"]},{"title":"click me!"},{"click":1,"selectstart":"return false"},[n.$if({e1:[9,"msg.isWarning"]},1,[n.elt("span",0,{"class":"warning"},0,[n.$text(0,["WARNING: "])])]),n.elt("span",0,0,0,[n.$text({e1:[9,"msg.text"]},["",1])])])];
});
