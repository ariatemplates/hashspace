...
var message = require("hsp/rt").template(["msg"], function(n){
  var _changeMessage;try {_changeMessage=changeMessage} catch(e) {_changeMessage=n.g('changeMessage')};
  return [n.elt("div",{e1:[4,1,_changeMessage]},{"title":"click me!"},{"click":1,"selectstart":"return false"},[n.$if({e1:[1,2,"msg","isWarning"]},1,[n.elt("div",0,{"class":"warning"},0,[n.$text(0,["WARNING: "])])]),n.$text({e1:[1,2,"msg","text"]},["",1," "])])];
});
