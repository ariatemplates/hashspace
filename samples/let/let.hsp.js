...
var test = require("hsp/rt").template(["m"], function(n){
  ...
  return [__s,n.let({e1:[9,"p1=m.part1, m21=m.part2.part21.msg+\"!\""]}),n.elt("div",0,0,0,[n.let({e1:[9,"p11=p1.part11"]}),n.$text(0,["Part 1.1: "]),n.elt("span",0,{"class":"textValue"},0,[n.$text({e1:[9,"p11.msg"]},["",1])]),n.elt("br",0,0,0)],1),n.elt("div",0,0,0,[n.$text(0,["Part 2.1: "]),n.elt("span",0,{"class":"textValue"},0,[n.$text({e1:[9,"m21"]},["",1])]),n.$text(0,[" - "]),n.$if({e1:[9,"!p11"]},1,[n.$text(0,["p11 is of course not visible in the 2nd element scope "])])]),n.elt("a",{e1:[4,1,_updateModel]},{"href":"javascript:void(0)"},{"click":1},[n.$text(0,["Change Model"])])];
});
