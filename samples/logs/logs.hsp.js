...
var test = require("hsp/rt").template(["cities","logs"], function(n){
  ...
  return [__s,n.log({e1:[9,"\"top-level:\",scope"]},'inline.js','',4,3),n.elt("a",{e1:[4,1,_increaseList]},{"href":"javascript:void(0)"},{"click":1},[n.$text(0,["Increase list"])]),n.$text(0,[" - "]),n.elt("a",{e1:[4,1,_decreaseList]},{"href":"javascript:void(0)"},{"click":1},[n.$text(0,["Decrease list"])]),n.$text(0,[" - "]),n.elt("a",{e1:[4,1,_clearLogs]},{"href":"javascript:void(0)"},{"click":1},[n.$text(0,["Clear logs"])]),n.elt("ul",0,0,0,[n.$foreach({e1:[9,"cities"]},"idx","city",0,1,[n.log({e1:[9,"\"item #\"+idx+\":\", city"]},'inline.js','',10,7),n.elt("li",0,0,0,[n.$text({e1:[9,"idx+1"],e2:[9,"city.name"]},["",1,". ",2])])]),n.$text(0,[" "])]),n.elt("div",0,{"class":"logsection"},0,[n.$text(0,["Logs: "]),n.elt("ul",0,{"class":"logs"},0,[n.$foreach({e1:[9,"logs"]},"msg_key","msg",0,1,[n.elt("li",0,0,0,[n.elt("span",0,{"class":"ctxt"},0,[n.$text({e1:[9,"msg.file"],e2:[9,"msg.line"],e3:[9,"msg.column"]},[" [",1," ",2,":",3,"] "])]),n.elt("span",0,{"class":"msg"},0,[n.$text({e1:[9,"msg.message"]},[" ",1," "])])])]),n.$text(0,[" "])])])];
});
