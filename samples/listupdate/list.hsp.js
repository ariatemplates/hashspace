...
var list = require("hsp/rt").template(["persons"], function(n){
  ...
  return [__s,n.elt("div",0,0,0,[n.elt("div",0,{"class":"msg"},0,[n.elt("a",{e1:[4,1,_addElement]},{"href":"javascript:void(0)"},{"click":1},[n.$text(0,["Add element"])]),n.$text(0,[" - "]),n.elt("a",{e1:[4,1,_deleteElement]},{"href":"javascript:void(0)"},{"click":1},[n.$text(0,["Delete element"])]),n.$text(0,[" - "]),n.elt("a",{e1:[4,1,_changeAll]},{"href":"javascript:void(0)"},{"click":1},[n.$text(0,["Change all elements"])])]),n.elt("ol",0,0,0,[n.$foreach({e1:[9,"persons"]},"p_key","p",0,1,[n.elt("li",0,0,0,[n.$text({e1:[9,"p.firstName"],e2:[9,"p.lastName"]},["",1," ",2," "]),n.$if({e1:[9,"p_isfirst"]},1,[n.elt("span",0,{"class":"info"},0,[n.$text(0,["(first)"])])]),n.$if({e1:[9,"p_islast"]},1,[n.elt("span",0,{"class":"info"},0,[n.$text(0,["(last)"])])])])]),n.$text(0,[" "])])]),n.elt("div",0,{"class":"msg"},0,[n.$text({e1:[9,"persons.length"]},["Number of people in the list: ",1," "])])];
});
