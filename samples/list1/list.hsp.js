...
var test = require("hsp/rt").template(["d"], function(n){
  ...
  return [__s,n.cpt([_list,"list"],0,{"head":"Static list","class":"listcpt"},0,[n.catt("option",0,0,0,[n.$text({e1:[9,"d.itemName"]},["First ",1])]),n.catt("option",0,0,0,[n.$text({e1:[9,"d.itemName"]},["Second ",1])])]),n.$text(0,[" "]),n.cpt([_list,"list"],0,{"class":"listcpt"},0,[n.catt("head",0,0,0,[n.$text(0,["Dynamic list: "]),n.elt("a",{e1:[4,1,_toggle]},{"href":"javascript:void(0)"},{"click":1},[n.$text(0,["Toggle favourite"])]),n.$text(0,[" - "]),n.elt("a",{e1:[4,1,_empty]},{"href":"javascript:void(0)"},{"click":1},[n.$text(0,["Empty"])]),n.$text(0,[" - "]),n.elt("a",{e1:[4,1,_update]},{"href":"javascript:void(0)"},{"click":1},[n.$text(0,["Update list"])])]),n.$if({e1:[9,"d.preferredOption"]},1,[n.catt("option",0,0,0,[n.$text({e1:[9,"d.preferredOption"]},["",1," (!)"])]),n.catt("separator",0,0,0)]),n.$foreach({e1:[9,"d.items"]},"idx","itm",0,1,[n.catt("option",0,0,0,[n.$text({e1:[9,"idx+1"],e2:[9,"itm"]},["",1,". ",2])])]),n.$text(0,[" "])])];
});
