...
var test = require("hsp/rt").template(["data"], function(n){
  var _data,_d1,_d2,_labels,_chart;try {_data=data} catch(e) {_data=n.g('data')};try {_d1=d1} catch(e) {_d1=n.g('d1')};try {_d2=d2} catch(e) {_d2=n.g('d2')};try {_labels=labels} catch(e) {_labels=n.g('labels')};try {_chart=chart} catch(e) {_chart=n.g('chart')};
  var __s = {data : typeof data === 'undefined' ? n.g('data') : data, d1 : typeof d1 === 'undefined' ? n.g('d1') : d1, d2 : typeof d2 === 'undefined' ? n.g('d2') : d2, labels : typeof labels === 'undefined' ? n.g('labels') : labels, chart : typeof chart === 'undefined' ? n.g('chart') : chart};
  return [__s,n.let({e1:[9,"datasets=(data.ds==\"d1\")? d1 : d2"]}),n.cpt([_chart,"chart"],{e1:[1,2,"data","type"],e2:[2,1,_labels],e3:[1,1,"datasets"]},{"width":"380","height":"220","type":["",1],"labels":["",2],"datasets":["",3]},0),n.elt("div",0,{"style":"padding:15 0 0 30"},0,[n.$text(0,[" Chart type: "]),n.elt("label",0,{"for":"rb1"},0,[n.elt("input",{e1:[1,2,"data","type"]},{"id":"rb1","type":"radio","model":["",1],"value":"line"},0),n.$text(0,["Line"])]),n.$text(0,["  "]),n.elt("label",0,{"for":"rb2"},0,[n.elt("input",{e1:[1,2,"data","type"]},{"id":"rb2","type":"radio","model":["",1],"value":"bar"},0),n.$text(0,["Bar"])]),n.elt("br",0,0,0),n.$text(0,[" Datasets: "]),n.elt("label",0,{"for":"rb3"},0,[n.elt("input",{e1:[1,2,"data","ds"]},{"id":"rb3","type":"radio","model":["",1],"value":"d1"},0),n.$text(0,[" d1"])]),n.$text(0,["  "]),n.elt("label",0,{"for":"rb4"},0,[n.elt("input",{e1:[1,2,"data","ds"]},{"id":"rb4","type":"radio","model":["",1],"value":"d2"},0),n.$text(0,[" d2"])])])];
});
